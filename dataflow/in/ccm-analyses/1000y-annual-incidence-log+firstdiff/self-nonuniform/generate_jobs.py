...
def get_ccm_settings():
    ...
    timeseries_y_label= 'log, fd annual cases' # below.
    ...
    max_theiler_window = 20             # Maximum window for exclude nearest neighbors temporally

    max_prediction_horizon = 100        # Twice the Theiler window is used to set the prediction
    ...
    log_transform = True                # If True, takes the natural log of samples.
                                        # If ADD_SAMPLES is True, then this is applied *after*
                                        # adding samples together.

    first_difference = True             # If True, first-differences time series.
