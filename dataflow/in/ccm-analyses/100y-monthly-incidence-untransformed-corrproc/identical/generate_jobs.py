...
def get_ccm_settings():
    ...
    max_theiler_window = 120             # Maximum window for excluding nearest neighbors temporally

    max_prediction_horizon = 240         # Twice the Theiler window is used to set the prediction
