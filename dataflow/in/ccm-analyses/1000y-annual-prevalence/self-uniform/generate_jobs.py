...
def get_ccm_settings():
    ...
    simulation_samples_offset = 9       # This starts the samples at an offset relative to the year
    ...
    max_theiler_window = 10             # Maximum window for exclude nearest neighbors temporally
    ...
    variable_name = 'logI'              # Can also be 'logS' or 'logI'.

    add_samples = False                 # If True, uses *sum* of original samples for analysis
    ...
    transform = 'exp'                   # If 'log', takes the natural log of samples.
                                        # If 'exp', exponentiates the samples.
