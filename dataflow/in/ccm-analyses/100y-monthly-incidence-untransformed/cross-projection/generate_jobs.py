...
#SIM_DB_PATH = os.path.join(SCRIPT_DIR, '..', '..', '..', 'simulations', 'results_gathered.sqlite')
...
def get_ccm_settings():
    ...
    standardize = True                  # If True, each time series is standardized to mean=0, sd=1.
                                        # This is applied after all other transformations.
    
    embedding_algorithm = 'tajima_projection'
